    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){        
                $editBtn = '<a href="'.route('admin.products-variant-items.edit', $query->id).'" class="btn btn-primary text-white ml-2 "><i class="far fa-edit"></i></a>' ;
                $deleteBtn = '<a href="'.route('admin.products-variant-items.destroy', $query->id).'" class="btn btn-danger text-white ml-2 delete-item"><i class="far fa-trash-alt"></i></a>' ;                
