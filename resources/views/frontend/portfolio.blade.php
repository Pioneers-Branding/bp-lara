...
<div class="h-16"></div>
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-gray-50 to-white">
        ...
        <!-- <div class="absolute inset-0 overflow-hidden">
            <div
                class="absolute top-0 left-0 w-64 h-64 bg-teal-100 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob">
            </div>
            <div
                class="absolute top-0 right-0 w-64 h-64 bg-purple-100 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000">
            </div>
            <div
                class="absolute bottom-0 left-1/2 w-64 h-64 bg-pink-100 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000">
            </div>
        </div> -->

        <div class="container mx-auto px-6 py-8 md:py-12 lg:py-18 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                <!-- Left Content -->
                <div class="lg:w-1/2 space-y-8">
                    <div class="inline-block px-4 py-2 bg-teal-100 text-teal-800 rounded-full text-sm font-medium mb-4">
                        Digital Marketing Excellence
                    </div>

                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        We <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-purple-600">Amplify</span>
                        Brands in the Digital Space
                    </h1>

                    <p class="text-lg text-gray-600 max-w-lg">
                        Full-service digital marketing agency crafting data-driven strategies that deliver measurable
                        results and explosive growth.
                    </p>

                    <!-- CTA Buttons -->
                    <div class="flex flex-col sm:flex-row gap-4 pt-4">
                        <a href="#work"
                            class="group relative px-8 py-4 overflow-hidden rounded-lg bg-gradient-to-r from-teal-600 to-teal-500 text-white font-medium transition-all duration-300 hover:shadow-xl hover:shadow-teal-100 hover:to-teal-600">
                            <span class="relative z-10">See Our Work</span>
                            <span
                                class="absolute inset-0 bg-gradient-to-r from-teal-700 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        </a>
                        <a href="#contact"
                            class="group relative px-8 py-4 overflow-hidden rounded-lg border-2 border-gray-200 text-gray-700 font-medium transition-all duration-300 hover:border-teal-400 hover:text-teal-600">
                            <span class="relative z-10">Get a Proposal</span>
                            <span
                                class="absolute inset-0 bg-teal-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        </a>
                    </div>

                    <!-- Stats Counter -->
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-12">
                        <div
                            class="text-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="text-3xl font-bold text-teal-600 counter" data-target="327">0</div>
                            <div class="text-gray-500 mt-1">Successful Campaigns</div>
                        </div>
                        <div
                            class="text-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="text-3xl font-bold text-teal-600 counter" data-target="89">0</div>
                            <div class="text-gray-500 mt-1">Happy Clients</div>
                        </div>
                        <div
                            class="text-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="text-3xl font-bold text-teal-600 counter" data-target="24">0</div>
                            <div class="text-gray-500 mt-1">Industry Awards</div>
                        </div>
                        <div
                            class="text-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div class="text-3xl font-bold text-teal-600 counter" data-target="10">0</div>
                ...
                <div class="lg:w-1/2 relative">
                    <div class="relative group">
                        <div
                            class="absolute -inset-2 bg-gradient-to-r from-teal-400 to-purple-500 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-500">
                        </div>
                        <div
                            class="relative rounded-xl overflow-hidden shadow-2xl transform transition duration-500 group-hover:-translate-y-2">
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Digital Marketing Team" class="w-full h-auto object-cover">
                            <div class="absolute inset-0 bg-gradient-to-b from-teal-500/10 to-teal-600/20"></div>
                            <div
                                class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                                <h3 class="text-white text-xl font-bold">Our Latest Campaign</h3>
                                <p class="text-teal-200 mt-1">Increased conversions by 240%</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Client Logo Slider - Enhanced -->
        <div
            class="bg-gradient-to-r from-gray-50 to-white py-12 md:py-16 border-t border-gray-100 relative overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-full h-full bg-gradient-to-r from-white via-transparent to-white z-10"></div>
            </div>
            <div class="container mx-auto px-6 relative z-20">
                <p class="text-center text-gray-500 mb-8 text-sm uppercase tracking-wider font-medium">Trusted by
                    leading
                    brands worldwide</p>
                <div class="relative w-full overflow-hidden h-16">
                    <div class="flex items-center logo-slide space-x-16 absolute top-0 left-0">
                        <!-- Logo items -->
                        <div class="flex-shrink-0">
                            <img src="https://logo.clearbit.com/google.com" alt="Google"
                                class="h-8 opacity-60 hover:opacity-100 transition duration-300 grayscale hover:grayscale-0">
                        </div>
                        <div class="flex-shrink-0">
    ...
    <div class="container max-w-7xl mx-auto mt-16 px-4 py-12">
        <!-- Header -->
        <div class="text-center mb-16">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">Our Client Portfolio</h1>
            <div class="h-1 w-24 bg-gradient-to-r from-teal-400 to-teal-600 rounded-full mx-auto"></div>
            <p class="text-gray-600 text-lg max-w-2xl mx-auto mt-4">Discover our successful partnerships across various
                industries</p>
        </div>
        ...
        <div class="mb-12">
            <div class="flex flex-wrap gap-6 justify-center">
                <select id="industryFilter"
                    class="px-4 py-2 rounded-lg border border-gray-200 text-gray-700 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 focus:outline-none transition-colors">
        ...
        <!-- Client Grid -->
        <div id="clientGrid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/9.3.2/swiper-bundle.min.js"></script>
    ...
    <script>
        const clients = [
            {
                ...
                logo: "https://cdn.brandfetch.io/idy-5oCG6y/w/1093/h/1093/theme/dark/icon.png?c=1bfwsmEH20zzEfSNTed",
                coverImage: "https://brandingpioneers.com/images/portfolio/nema-care-65292a172bc64.webp",
                industry: "healthcare",
                services: ["seo", "webdev", "social"],
                serviceNames: ["SEO", "Web Development", "Social Media Marketing"],
                description: "Leading healthcare provider revolutionizing patient care through digital innovation."
            },
            {
                ...
                serviceNames: ["SEO", "Content Marketing", "Social Media Marketing"],
                description: "Luxury real estate company specializing in premium properties and developments."
            },
            {
                ...
                industry: "finance",
                services: ["webdev", "seo"],
                serviceNames: ["Web Development", "SEO"],
                description: "Innovative financial services firm providing cutting-edge investment solutions."
            },
            {
                name: "ShopNow",
                logo: "https://cdn.brandfetch.io/idy-5oCG6y/w/1093/h/1093/theme/dark/icon.png?c=1bfwsmEH20zzEfSNTed",
                coverImage: "https://brandingpioneers.com/images/portfolio/nema-care-65292a172bc64.webp",
                industry: "ecommerce",
                services: ["webdev", "social", "content"],
                serviceNames: ["Web Development", "Social Media Marketing", "Content Marketing"],
                description: "Next-generation e-commerce platform transforming online shopping experiences."
            }
        ];
                ...
                const clientCard = `
                    <div class="card-hover bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100">
                        <div class="relative h-48">
                            <img src="${client.coverImage}" alt="${client.name} Cover" class="w-full h-full object-cover" />
                            <div class="absolute inset-0 gradient-overlay"></div>
                            <img src="${client.logo}" alt="${client.name} Logo" class="absolute bottom-4 left-4 w-16 h-16 object-contain bg-white rounded-lg p-2 shadow-md" />
                        </div>
                        <div class="p-6">
                            <h2 class="text-xl font-bold text-gray-900 mb-2">${client.name}</h2>
                            <p class="text-gray-600 text-sm mb-4">${client.description}</p>
                            <div class="mb-4">
                                <span class="inline-block bg-teal-50 text-teal-700 px-3 py-1 rounded-full text-sm">
                                    ${client.industry.charAt(0).toUpperCase() + client.industry.slice(1)}
                                </span>
                            </div>
                            <div>
                                <h3 class="text-gray-900 font-medium mb-2">Services:</h3>
                                <div class="flex flex-wrap gap-2">
                                    ${client.serviceNames.map(service =>
        ...
        function filterClients() {
            ...
            if (industryFilter !== 'all') {
                filteredClients = filteredClients.filter(client => client.industry === industryFilter);
            }

            if (serviceFilter !== 'all') {
                filteredClients = filteredClients.filter(client => client.services.includes(serviceFilter));
            }
        ...
        document.getElementById('industryFilter').addEventListener('change', filterClients);
        document.getElementById('serviceFilter').addEventListener('change', filterClients);
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Initial setup
            gsap.set(".hero-image, .counter, .logo-slide", { opacity: 0, y: 20 });
