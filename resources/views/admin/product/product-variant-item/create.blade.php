...
<section class="section">
    ...
    <div class="section-body">
          ...
          <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                  <a href="{{ route('admin.products-variant.index', ['productId' => $product->id, 'variantId' => $variant->id] )}}" class="btn btn-primary">
                    Back
                  </a>
                </div>               
              </div>            
      ...
      <form action="{{ route('admin.products-variant-items.store') }}" enctype="multipart/form-data" method="POST"> 
        @csrf
        <div class="row">
          <div class="col-12">
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <select class="form-control form-control-lg" name="is_default" value="{{ old('is_default') }}">
